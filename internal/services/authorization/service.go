...
type ApplicationService struct {
	policyDomain   policy.IService
	identityDomain identity.IService
	logger         utils.Logger
}

// NewApplicationService creates a new authorization application service.
func NewApplicationService(policyDomain policy.IService, identityDomain identity.IService, logger utils.Logger) *ApplicationService {
