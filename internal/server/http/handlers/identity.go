...
type IdentityHandlers struct {
	identityService identity.IApplicationService
	logger          utils.Logger
}

// NewIdentityHandlers creates a new set of identity handlers.
func NewIdentityHandlers(identityService identity.IApplicationService, logger utils.Logger) *IdentityHandlers {
